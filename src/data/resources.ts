...
// Resource grouping metadata rules:
...
export const resources: Resource[] = [
  {
    ...
    internality: "washu",
    needs: ["ip-licensing", "expertise-mentorship"],
  ...
  },
  {
    ...
    inventionTypes: ["devices-diagnostics", "software-digital", "research-tools"],
    locations: ["washu"],
  ...
  },
  {
    ...
    internality: "washu",
    needs: ["expertise-mentorship", "industry-connections"],
    inventionTypes: ["broad"],
    locations: ["washu"],
  ...
  },
  {
    ...
    type: "resource",
    title: "Center for Drug Discovery (CDD)",
    organization: "WashU Medicine · Center for Drug Discovery",
    url: "https://cdd.wustl.edu/",
    internality: "washu",
    needs: ["build-test", "funding"],
    inventionTypes: ["therapeutics"],
    locations: ["washu"],
    domains: ["therapeutic"],
    states: ["s1", "s2", "s3", "s6", "s7"],
    problemsSolved: [
      "drug-discovery",
  ...
  },
  {
    ...
    type: "resource",
    title: "Center for Clinical Studies (CCS)",
    organization: "Washington University in St. Louis",
    url: "https://research.washu.edu/offices/center-for-clinical-studies/",
    internality: "washu",
    needs: ["build-test", "expertise-mentorship"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    ...
    states: ["s6", "s7", "s8"],
    problemsSolved: ["clinical-study-operations", "trial-startup", "study-closeout"],
    whatYouGet:
    ...
    nextDeadline: null,
    lastVerified: "2026-09-06",
    sourceUrls: ["https://research.washu.edu/offices/center-for-clinical-studies/"],
    contact: "ccs@wustl.edu · 314-747-4000",
  },
  {
    id: "icts-regulatory-support",
    type: "resource",
    title: "ICTS Regulatory Support Center (RSC)",
    organization: "Institute of Clinical and Translational Sciences, WashU",
    url: "https://icts.wustl.edu/items/regulatory-support-center-rsc/",
    internality: "washu",
    needs: ["expertise-mentorship", "build-test"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    domains: ["therapeutic", "device", "diagnostic", "software", "clinical-workflow"],
    states: ["s6", "s7", "s8"],
    problemsSolved: ["regulatory", "ind", "ide", "irb", "clinical-trial"],
    whatYouGet:
  ...
  },
  {
    ...
    url: "https://icts.wustl.edu/items/trial-care/",
    internality: "washu",
    needs: ["build-test", "expertise-mentorship"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    domains: ["therapeutic", "device", "diagnostic", "software", "clinical-workflow"],
    states: ["s6", "s7", "s8"],
    problemsSolved: ["multicenter-trial", "trial-startup", "recruitment", "single-irb"],
    whatYouGet:
  ...
  },
  {
    ...
    type: "resource",
    title: "mHealth Research Core (mHRC)",
    organization: "Institute of Clinical and Translational Sciences, WashU",
    url: "https://icts.wustl.edu/items/mhealth-research-core/",
    internality: "washu",
    needs: ["build-test", "expertise-mentorship"],
    ...
    states: ["s1", "s2", "s3", "s6", "s7"],
    problemsSolved: ["digital-health", "mhealth", "remote-research", "part-11"],
    whatYouGet:
  ...
  },
  {
    ...
    internality: "washu",
    needs: ["startup-support", "expertise-mentorship"],
    inventionTypes: ["broad"],
    locations: ["washu"],
  ...
  },
  {
    ...
    url: "https://siteman.washu.edu/research/funding-opportunities/",
    internality: "washu",
    needs: ["funding"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    domains: ["therapeutic", "device", "diagnostic", "software", "research-tool"],
    states: ["s1", "s2", "s3", "s6"],
    problemsSolved: ["pilot-funding", "preliminary-data", "cancer"],
    whatYouGet:
    ...
    requiresDisclosure: false,
    companyRequired: false,
    funding: "Pilot funding; amount and categories are cycle-specific",
    caveats: [
    ...
    investigatorReturns: ["pilot data", "external-grant leverage", "cross-disciplinary cancer collaborations"],
    nextStates: ["s2", "s3", "s6"],
    status: "evergreen_program_verify_current_call",
    nextDeadline: null,
    lastVerified: "2026-09-06",
    sourceUrls: ["https://siteman.washu.edu/research/funding-opportunities/"],
    priority: "second",
    purposes: ["research", "funding"],
  },
  {
    id: "ecrc",
    type: "resource",
    title: "Emergency Care Research Core (ECRC)",
    organization: "Washington University in St. Louis · Department of Emergency Medicine",
    url: "https://research.washu.edu/core-facilities/ecrc/",
    internality: "washu",
    needs: ["build-test", "expertise-mentorship"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    domains: ["therapeutic", "device", "diagnostic", "clinical-workflow"],
    states: ["s6", "s7"],
    problemsSolved: ["emergency-care", "clinical-research", "feasibility", "recruitment", "enrollment"],
    whatYouGet:
    ...
    companyRequired: false,
    funding: null,
    caveats: ["Highly specialized; show only when emergency-care context is relevant."],
    investigatorReturns: ["emergency-care feasibility", "patient recruitment/enrollment support", "more executable acute-care studies"],
    nextStates: ["s7"],
    status: "evergreen",
    nextDeadline: null,
    lastVerified: "2026-09-06",
    sourceUrls: ["https://research.washu.edu/core-facilities/ecrc/"],
    priority: "second",
    purposes: ["research", "expertise"],
  },
  {
  ...
  },
  {
    id: "nih-ninds-sbir",
    type: "resource",
    title: "NIH SBIR/STTR small-business funding",
    ...
    requiresDisclosure: false,
    companyRequired: true,
    funding: "NIH SBIR/STTR (verify current NOFO and institute fit)",
    caveats: [
  ...
  },
  {
    ...
    internality: "washu",
    needs: ["ip-licensing", "startup-support"],
    inventionTypes: ["broad"],
    locations: ["washu"],
    domains: ["therapeutic", "device", "diagnostic", "software"],
    states: ["s8"],
  ...
  },
  {
    ...
    internality: "investor",
    needs: ["funding", "startup-support"],
    inventionTypes: ["therapeutics", "devices-diagnostics"],
    locations: ["st-louis"],
  ...
  },
  {
    ...
    internality: "federal",
    needs: ["expertise-mentorship", "startup-support"],
    inventionTypes: ["broad"],
    locations: ["national"],
    domains: ["therapeutic", "device", "diagnostic", "software", "research-tool"],
    states: ["s8"],
  ...
  },
  {
    ...
    internality: "federal",
    needs: ["funding"],
    inventionTypes: ["devices-diagnostics"],
    locations: ["national"],
